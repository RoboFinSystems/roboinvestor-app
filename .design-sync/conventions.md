...
| Family        | Role                                       | Example                                                      |
| ------------- | ------------------------------------------ | ------------------------------------------------------------ |
| `primary-*`   | brand (emerald) — primary actions, accents | `bg-primary-600`, `text-primary-600`, `hover:bg-primary-700` |
| `secondary-*` | teal — secondary accents, chat user bubble | `bg-secondary-500`                                           |
| `accent-*`    | cyan — tertiary accents, gradients         | `text-accent-500`                                            |
