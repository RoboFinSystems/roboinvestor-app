...
function setup_minimum_config() {
    ...
    read -p "Repository Name [RoboFinSystems/roboinvestor-app]: " REPOSITORY_NAME
    REPOSITORY_NAME=${REPOSITORY_NAME:-"RoboFinSystems/roboinvestor-app"}
    read -p "ECR Repository Name [roboinvestor-app]: " ECR_REPOSITORY
...
function setup_full_config() {
    ...
    read -p "Enter Domain Name (e.g., robosystems.ai): " DOMAIN_NAME
    read -p "Enter AWS Account ID: " AWS_ACCOUNT_ID
    read -p "Enter Repository Name [RoboFinSystems/roboinvestor-app]: " REPOSITORY_NAME
    REPOSITORY_NAME=${REPOSITORY_NAME:-"RoboFinSystems/roboinvestor-app"}
    read -p "Enter ECR Repository Name [roboinvestor-app]: " ECR_REPOSITORY
    ECR_REPOSITORY=${ECR_REPOSITORY:-"roboinvestor-app"}
