...
<!-- The substantive changes, grouped by route, page, or module. Name the user-visible surface —
     that is what a reviewer is looking for in a frontend PR. If this alters a number an investor
     reads — a position, holding, valuation, or return figure — say so precisely. -->
