...
// RoboInvestor's product docs at roboinvestor.ai/docs, written in the robosystems repo
// under docs/product/roboinvestor/ and published to the shared docs catalog. The index
// page is the docs home.

export const revalidate = 300

const BASE_URL = 'https://roboinvestor.ai'
...
export default async function ProductDocsPage({ params }: Props) {
  ...
  return (
    <DocsArticle
      ...
      body={body}
      crumbs={crumbs}
      collectionTitle="RoboInvestor docs"
      baseUrl={BASE_URL}
    />
  )
}
