...
const CDN = 'https://assets.robosystems.ai/docs/product/roboinvestor/images'
...
describe('DocsImage', () => {
  ...
  it.each([
    ...
    render(<DocsImage src={src} alt="A tour of RoboInvestor" />)
    const frame = screen.getByTitle('A tour of RoboInvestor')
