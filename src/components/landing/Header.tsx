      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <nav className="hidden items-center space-x-6 md:flex">
            ...
            <Link
              href="/register"
              className="from-primary-500 to-secondary-500 shadow-primary-500/25 hover:shadow-primary-500/40 ml-2 rounded-lg bg-linear-to-r px-4 py-2 text-sm font-medium text-white shadow-lg transition-all"
            >
              Register
            </Link>
          </nav>
