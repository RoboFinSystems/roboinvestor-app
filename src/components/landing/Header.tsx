...
// Section links carry the root path so they resolve from the docs too, where the header
// also renders. Five links on purpose: the row has to fit beside GitHub, Login and
// Register from lg (1024px) up. Open app, which replaces the last two once signed in, is
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Desktop Navigation */}
          {/* lg, not md: the logo and the full nav measure ~890px, which fits
              the 960px row at lg (1024px) with room to spare. Switching at md
              (768px) would clip Login and Register off the fixed header with
              the hamburger already hidden */}
          <nav className="hidden items-center space-x-5 lg:flex lg:space-x-6">
            ...
            <a
              ...
              aria-label="RoboInvestor on GitHub"
