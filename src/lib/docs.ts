...
//
// The catalog is shared with robosystems-app and roboledger-app: each page carries
// a `site` and a `layer`, and each app renders its own. This app renders
// roboinvestor.ai's product pages.
...
export const DOCS_SITE = 'roboinvestor'
